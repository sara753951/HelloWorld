...
/**
 * Created by yanxinming on 2018/12/4
 */
public class mhtTest {
    ...
    public static void main(String[] args) {
        ...
        mht2html("/Users/yanxinming/项目文件/简历解析/简历/测试数据/本地测试/mhtTest/yanxxxxxxxxxxx.doc", "/Users/yanxinming/项目文件/简历解析/简历/测试数据/本地测试/mhtTest/wangqun.doc.html");
    }
    /**
     * 将 mht文件转换成 html文件
     *
